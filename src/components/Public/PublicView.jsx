...
const PublicView = () => {
  ...
  <div className="w-full  flex justify-end mt-10">
    <input
      ...
      onChange={filter}
      className=" border-2 border-black mr:5 w-[230px] h-10 sm:mr-5 lg:mr-8"
    />
  </div>
  ...
  <div className="mx-auto mt-10 w-[96%] overflow-x-auto">
    {records.length > 0 ? (
      <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead className="text-xs uppercase text-center bg-[#a6a6a6]  dark:text-black">
          <tr>
        ...
        <tbody className="">
          ...
          {records.map((item, i) => (
            <tr key={i} className=" mt-10 border-2 sm:text-left  dark:bg-gray-100 dark:border-gray-800">
              <th
                scope="row"
