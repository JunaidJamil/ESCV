...
//                       </li>
//                       <li className='footer-item'>
//                         <Link to='/honors-and-achievements' className='footer-links' >
...
//                       </li>
//                       <li className='footer-item'>
//                         <Link to='/publications' className='footer-links' >
//                           Publications
//                         </Link>
//                       </li>
//                       <li className='footer-item' >
//                         <Link to='/phd' className='footer-links' >
//                           Capacity Building
//                         </Link>
//                       </li>
//                       <li className='footer-item'>
...
//                     <p>Embedded Systems and Computer Vision Lab<br></br><br></br>
//                     Computer and Information Systems Department, NED University of Engineering & Technology, University Road, 75270, Karachi.</p>                    
//                   </div>
...
//                     <h5>SOCIALS</h5>
//                     <ul>
//                       <li><i className='fas fa-phone'></i>123456789</li>
//                       <li><i className='fas fa-envelope-open'></i>escv@gmail.com</li>
//                       <li><i className='fa-brands fa-linkedin'></i>linkedin.com</li>
//                     </ul>
//                 </div>
